...
function spellCheck(e){
  ...
  let _originText = document.querySelector("#origin-text p").innerText;
...
function setOriginText(list){
  ...
  document.querySelector("#origin-text p").innerHTML += '<span class="colourDefault">'+s+'</span>';
}
